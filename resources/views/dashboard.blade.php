        ...
        <div class="max-w-7xl mx-auto pt-20 px-4">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <!--add competence-->
                    <div class="bg-white rounded-xl shadow-sm p-4">
                        <h3 class="font-semibold mb-4">Add skill</h3>
                       <a href="{{ route('addComp') }}" class="bg-gray-600 hover:bg-gray-800 text-gray-100  rounded-lg px-2 py-2 flex-grow transition-colors duration-200">
                        add skill
</a>
                    </div>
                </div>
